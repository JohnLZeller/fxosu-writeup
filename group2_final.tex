...
Our API is added into the core of Gecko, allowing it to be easily added to any platform that Firefox is compiled for, assuming of course that there are no conflicts between our source code functionalty and the compiled platform implementation. Here is an explanation about what each piece of this source code structure is for.
